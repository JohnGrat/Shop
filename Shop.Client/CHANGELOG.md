...
- Create Angular project with ng: `ng new shop.client --defaults --skip-install --skip-git `.
...
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `shop.client.esproj`).
